...
public class EntryController {
    ...
    public @ResponseBody
    List<Entry> addEntry(@RequestBody Entry entry) {
    ...
    public @ResponseBody
    List<Entry> deleteEntry(@RequestBody Entry entry) {
